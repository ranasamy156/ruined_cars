  ...
  <body class="skin-yellow sidebar-mini" class="bodycss"  style="font-family:'Amiri', serif;">
    <div class="wrapper" >
      ...
      <div class="content-wrapper">
         ...
         <table style="font-size:1vw;width:100%;text-align:<?php echo $expr['align'] ?>;" class="table bg-default">
         <thead>
                  <tr>
                ...
                foreach($rs as $row){
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td scope="row"><a href="delcar.php?n=<?php echo ($row["id"]); ?>"><?php echo $expr['remove'] ?></a></td>
                      </tr>
                    </tbody>
                    <?php
