    ...
    if($rowdate = mysqli_fetch_assoc($query)){
      ...
      foreach($query as $rowdate){
        ...
        if($enddate1 <= date("Y-m-d")){
          $rs3 = $dbdate->RunDML("update request set status_id = '14'  WHERE status_id not in (15,24,25,26,27,28) and DATE(created_at) + INTERVAL 1 DAY <= DATE(NOW()) and direct = 0 and id=".$rowdate['id']);
        }
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <?php
                  include_once 'database.php';
                  $newdb = new Database();
                  $new = $newdb->GetData("select * from notification where seen = '0' and type_id = '3' ORDER BY id DESC");
               ...
               <li class="dropdown notifications-menu">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="label label-success"><?php echo $noti_rows ?></span>
                </a>
      ...
      <div class="content-wrapper">
        ...
        <div class="search-container">
          ...
          <div class="row">
              ...
              <div class="col-sm-2">
              <div class="dropdown ltr" style="float:left;margin-top:15px;margin-<?php echo $expr['left'] ?>:15px;">
                <button class="btn btn-warning dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown">
                <?php echo $expr['printreport'] ?>                  
                  <span class="caret"></span>
                </button>

                <ul class="dropdown-menu dropdown-menu-left" role="menu" aria-labelledby="dLabel">
                  <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" href="reportrequests.php?n=0"><?php echo $expr['printrequests'] ?></a></li>
                  <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" href="reportcars.php?n=13">تقرير الطلبات المقبولة</a></li>
                  <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" href="reportcars.php?n=14">تقرير سيارات جاهزة للرفع (مضى عليها 15 يوم)</a></li>
                  <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" href="reportrequests.php?n=1">تقرير السيارات المحجوزة (خلال 90 يوم)</a></li>
                  <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" href="reportrequests.php?n=2">تقرير السيارات المحجوزة (مضى عليها 90 يوم)</a></li>
                  <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" href="reportcars.php?n=15">تقرير الطلبات المرفوضة</a></li>
                  <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" href="reportcars.php?n=17">تقرير طلبات الموافقة الضمنية</a></li>
                  <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" href="reportcars.php?n=24">تقرير سيارات تم استرجاعها للمالك</a></li>
                  <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" href="reportcars.php?n=25">تقرير سيارات تم نقل ملكيتها للمقاول</a></li>
                  <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" href="reportcars.php?n=26">تقرير طلبات تم وقف العمل عليها</a></li>
                </ul>
              </div>
              </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box" style="background-color:#FFB717;color:white;">
                ...
                include_once 'database.php';
                $db1 = new Database();
                $rss = $db1->GetData("select * from request where status_id ='14'");
                  $bk =$rss->num_rows;
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-orange">
                ...
                include_once 'database.php';
                $dbb1 = new Database();
                $rsss = $dbb1->GetData("select * from request where status_id ='24'");
                  $bkk =$rsss->num_rows;
            ...
            <div class="table-responsive">
              <table class="table bg-default">
                ...
                <?php
                  ...
                  <tbody>
                        <tr>
                          <th scope="row"><?php echo "لا يوجد طلبات"; ?></th>
                          </tr>
                      </tbody>
                    <?php } ?>
              </table>
