    ...
    class Requests extends Database implements Operation{
       ...
       var $user_id; var $created_at; var $status_id;
        ...
        public function update(){
            $m=parent::RunDML("update request set status_id='20' where id='".$_GET["id"]."' ");
            return $m;
        }
        ...
        //     $rs=parent::GetData("select inv.*, us.name as name,st.description as status_name from investigation inv, request rq, status st, users us where (rq.plate_number like '%".$_GET["n"]."%' or rq.en_platenum like '%".$_GET["n"]."%') and rq.user_id = us.id and inv.status_id=st.id and rq.status_id not in ('10', '12', '11', '18')");
        //     return $rs;
