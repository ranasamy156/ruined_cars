  ...
  if($row=mysqli_fetch_assoc($log)){
    ...
    if($rowdate = mysqli_fetch_assoc($query)){
      ...
      if($enddate2 <= date("Y-m-d")){
        $rs3 = $dbdate->RunDML("update request set ready_to_close = 2  WHERE status_id not in (15,24,25,26,27,28) and DATE(accepted_at) + INTERVAL 90 DAY <= DATE(NOW()) and id=".$rowdate['id']);
      }
      }
    }
        ...
        <section class="content">
          ...
          <div class="row">
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box" style="background-color: #1c8a63;color: white;">
                <div class="inner">
                <?php
            ...
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box" style="background-color: #60bd7e;color: white;">
                <div class="inner">
                <?php
                include_once 'RequestClass.php';
                $req1 = new Requests();
            ...
            <div class="col-lg-3 col-xs-6">
              <!-- small box -->
              <div class="small-box" style="background-color: #66b398;color: white;">
                <div class="inner">
                    <?php
                include_once 'database.php';
                $dbb1 = new Database();
