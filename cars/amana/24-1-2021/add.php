      ...
      <div class="content-wrapper" >
          ...
          <div class="row">
            ...
            <label for="identification">رقم الهوية</label>
                <input type="number" name="identification" id="identification" style="width:50%">
            </div>
            <div class="col-md-3">
            ...
            <?php if($_SESSION['perm'] == 'super'){ ?>
            <div class="col-md-3">
            <label for="type">نوع المستخدم</label>
                <select name="type" id="type">
                  <option value="amana">امانة</option>
                  <option value="traffic">مرور</option>
                  <option value="criminal">مباحث جنائية</option>
                  <option value="vendor">مقاول</option>
                </select>
            </div>
            <?php } ?>
            <div class="col-md-12">
          <button class="btn btn-primary" name="btnadd" style="margin-top: 15px;margin-right: 120px;"><?php echo $expr['add'] ?></button>
            ...
            <?php
              ...
              {
                echo("<script> window.open('addmob.php' , '_self') </script>");
