...
<button type="button" class="btn btn-default btn-sm" data-toggle="modal" data-target=".bd-example-modal-lgg">تعديل عدد ايام طلبات الموافقة الضمنية</button>
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-header">
                <h4 class="modal-title" id="myLargeModalLabel">تعديل عدد ايام طلبات الموافقة الضمنية</h4>
              ...
              <form method="post">
                <div>
                  <input class="form-control" style="width:50%" type="text" name="daysnumber" value="<?php echo $row2['number'] ?>" />
                </div>
                <button class="btn btn-primary" name="sendpro"><?php echo $expr['edit'] ?></button>
                <?php
                  if(isset($_POST['sendpro'])){
                    $up = $req1->RunDML("update num_accept set number = '".$_POST['daysnumber']."' where id = 1");
          ...
          <div class="row">
            <div class="col-md-12 m-auto">
              ...
              <table class="table bg-default">
                ...
                include_once '../database.php';
                $req1 = new Database();
                $rs = $req1->GetData("select rq.* ,st.description as status_name ,us.name from request rq ,statuses st, users us where rq.user_id = us.id and rq.status_id=st.id and rq.status_id = '17' order by rq.id desc");
