...
.adminpanel{
  ...
  <div class="wrapper" >
      ...
      <h3 style="font-size:x-large;font-family:'Amiri', serif;" class="navbar-brand"><?php echo $expr['news'] ?></h3>

      <table style="text-align:<?php echo $expr['align'] ?>;width:100%" class="table table-borderd table-striped">
                <thead>
                  <tr>
                  <th scope="col"><?php echo $expr['news']; ?></th>
                 ...
                 if ($row = mysqli_fetch_assoc($rs)) {
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td><a href="delnews.php?n=<?php echo ($row["id"]); ?>"><?php echo $expr['remove']; ?></a></td>
                      </tr>
                    </tbody>
                    <?php
                      }
            ...
            <tbody>
                      <tr>
                        <th scope="row"><p><?php echo $expr['nonews']; ?></p></th>
                      </tr>
                    </tbody>
            <?php
             }
