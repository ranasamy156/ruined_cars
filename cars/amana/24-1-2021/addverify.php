  ...
  <body class="skin-green sidebar-mini" class="bodycss"  style="font-family:'Amiri', serif;">
    <div class="wrapper" >
      ...
      <div class="content-wrapper" >
          ...
          <div class="row">
            <div class="col-md-12">
            <label for="identification">Verification Code</label>
                <input type="text" name="identification" id="identification" style="width:50%">
            </div>
            <div class="col-md-12">
          <button class="btn btn-primary" name="btnadd" style="margin-top: 15px;margin-right: 120px;">تأكيد</button>
          </div>
          </div>
            <?php
              if(isset($_POST["btnadd"]))
              {
                ...
                echo("<script> window.open('adddetails.php' , '_self') </script>");
