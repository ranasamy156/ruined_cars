          ...
          <div class="row">
            <div class="col-md-12 m-auto">
              ...
              <table class="table bg-default">
                ...
                include_once '../database.php';
                $req1 = new Database();
                $rs = $req1->GetData("select rq.* ,st.description as status_name ,us.name from request rq ,statuses st, users us where rq.user_id = us.id and rq.status_id=st.id and rq.status_id in (24,25,26) order by rq.id desc");
