<?php
    ...
    class Users extends Database implements Operation{
       ...
       public function add(){
            ...
            '".$this->getusername()."' , '".$this->getpassword()."' , '4', 'regular', 'nonsuper')");
        ...
        public function update(){
            ...
            user_name='".$this->getusername()."' , password='".$this->getpassword()."' , type_id='4' where id='".$_GET["n"]."' ");
            
        }
        public function update2(){
            $m=parent::RunDML("update users set name='".$this->getname()."' , phone='".$this->getphone()."' , 
            user_name='".$this->getusername()."' , password='".$this->getpassword()."' , type_id='4' where id='".$_SESSION["id"]."' ");
            
        }

        public function GetAll(){
            $rs=parent::GetData("select * from users where id != '".$_SESSION['id']."' and type_id='4'");
            return $rs;
        }
