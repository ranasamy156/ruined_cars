...
.adminpanel{
  ...
  <body class="skin-blue sidebar-mini" class="bodycss"  style="font-family:'Amiri', serif;">
    ...
    <div class="adminpanel">
      ...
      <h3 style="margin-top: -25px;font-size: xx-large;font-family:'Amiri', serif;" class="navbar-brand"><?php echo $expr['requestdetails'] ?></h3>
          <div>
          <table style="text-align:<?php echo $expr['align'] ?>;font-size:medium;width:100%" class="table table-borderd table-striped">
            ...
            <?php  
              ...
              $proc=new Database();
              $msg = $proc->GetData("select * from procedures");
            ?>
            <tr>
              <td> <?php echo $expr['procedures'] ?> </td>
              <td>
              <div class="dropdown" style="float:center;">
                  <select name="procedures" style="width:95px;">
                    <option value="choose" selected disabled><?php echo $expr['choose'] ?> <?php echo $expr['procedure'] ?></option>
                    <?php 
                    if($row3 = mysqli_fetch_assoc($msg)){
                    foreach ($msg as $row3){?>
                    <option value="<?php echo ($row3["description"]); ?>"><?php echo ($row3["description"]); ?></option>
                    <?php }} ?>
                  </select>
              </div>
              </td>
...
<!-- end of procedures -->
          ...
          <a href="delreq.php?n=<?php // echo ($row["id"]); ?> " class="btn btn-danger btn-lg" style="float:left">رفض الطلب</a>
