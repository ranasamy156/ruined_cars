...
if (isset($_SESSION["id"])) {
    if($_SESSION["type_id"] == "1") {
      ...
      $req1 = new Database();
      $rs = $req1->GetData("select rq.* ,st.description as status_name ,model.name as model_name ,model.en_name as model_arname ,man.name as man_name,man.ar_name as man_arname,us.name from request rq ,statuses st, users us, models model, manufactures man where rq.user_id = us.id and rq.status_id=st.id and rq.model_id=model.id and model.manufacture_id=man.id and rq.status_id in (27,28,33,15) order by rq.id desc");
...
.navbar-nav>.user-menu>.dropdown-menu>li.user-header {
  ...
  <div class="row ">
    ...
    <center><h2 class="" style="text-align:center;font-family:'Amiri', serif;">تقرير السيارات المرفوضة</h2></center>
  ...
  <div class="row">
    ...
    <?php
      ...
      if($ex[0] <= 1900){
        ...
        echo ("<script> window.open('reportrefusedse.php?f=$result&t=$result2' , '_self') </script>");
      }
    ?>
