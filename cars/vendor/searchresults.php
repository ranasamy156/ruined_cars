...
if (isset($_SESSION["id"])) {
 if (!isset($_SESSION['time'])) {//Save login datetime to the session
    $_SESSION['time']=time();
        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="24-1-2021/addstatus.php"><i class="fa fa-circle-o"></i> <?php echo $expr['statuslist'] ?> </a></li>
                <li><a href="24-1-2021/reqlist.php"><i class="fa fa-circle-o"></i><?php echo $expr['addstatus'] ?></a></li>
              </ul>
            </li>
            <li>
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box bg-blue">
                ...
                include_once 'database.php';
                $dbu = new Database();
                $ris = $dbu->GetData("select * from request where status_id ='21'");
                  $ta =$ris->num_rows;
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="small-box" style="background-color: #5B5BF0;color:white;">
                ...
                include_once 'database.php';
                $db1 = new Database();
                $rss = $db1->GetData("select * from request where status_id ='22'");
                  $bk =$rss->num_rows;
                ...
                ?>
                    <tbody>
                      <tr>
                        ...
                        <td><a style="text-align: center;text-decoration: none;color: aqua;" href="24-1-2021/request.php?n=<?php echo ($row["id"]); ?>"><p>&#8592;</p></a></td>
                      </tr>
                    </tbody>
                <?php
                  }
...
<?php
  ...
  header('location:www.alsaifit.com');
}
?>
